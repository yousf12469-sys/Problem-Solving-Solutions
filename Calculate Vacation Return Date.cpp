...
sDate CalculateVacationDay(sDate DateFrom, short VacationsDay)
{
    ...
    for (int i = 1; i <= VacationsDay + WeekEndCounter; i++)
    {
...
int main()
{
    ...
    sDate ReturnDate = CalculateVacationDay(DateFrom, VacationDays);
